...
if(isset($_POST['upload_furniture'])){
...
//get all the submitted data from the form
    ...
    $sql = "INSERT INTO furniture(image,text,price,location,number)VALUES('$image','$text','$price','$location','$number')";
...
<div id="content">
    ...
    <form action="upload_furniture.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="image_upload_box">
            <input type="submit" name="upload_furniture" value="Upload Product🎉" class="btn btn-success">
        </div>
